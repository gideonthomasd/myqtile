...
sudo apt update
sudo apt install python3-dev python3-full python3-pip libpangocairo-1.0-0 python3-cffi python3-xcffib git libxkbcommon-dev libxkbcommon-x11-dev librust-xkbcommon-dev pyconfigure -y
